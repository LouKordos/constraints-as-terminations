...
def generate_launch_description():
    ...
    base_frame_arg = DeclareLaunchArgument(
        "base_frame",
        default_value="base",
        description="Base frame name passed from locomposition_bringup/launch/bringup.launch.py."
    )
    livox_frame_arg = DeclareLaunchArgument(
        "livox_frame",
        default_value="livox_frame",
        description="Livox frame name passed from locomposition_bringup/launch/bringup.launch.py."
    )
    vicon_base_frame_arg = DeclareLaunchArgument(
        "vicon_base_frame",
        default_value="vicon/Go2_Loukas/Go2_Loukas",
        description="Vicon base frame name passed from locomposition_bringup/launch/bringup.launch.py."
    )
    base_to_livox_x_arg = DeclareLaunchArgument(
        "base_to_livox_x",
        default_value="0.34",
        description="Base-to-Livox X offset passed from locomposition_bringup/launch/bringup.launch.py."
    )
    base_to_livox_y_arg = DeclareLaunchArgument(
        "base_to_livox_y",
        default_value="0.0",
        description="Base-to-Livox Y offset passed from locomposition_bringup/launch/bringup.launch.py."
    )
    base_to_livox_z_arg = DeclareLaunchArgument(
        "base_to_livox_z",
        default_value="0.155",
        description="Base-to-Livox Z offset passed from locomposition_bringup/launch/bringup.launch.py."
    )
    base_to_livox_yaw_arg = DeclareLaunchArgument(
        "base_to_livox_yaw",
        default_value="0.0",
        description="Base-to-Livox yaw passed from locomposition_bringup/launch/bringup.launch.py."
    )
    base_to_livox_pitch_arg = DeclareLaunchArgument(
        "base_to_livox_pitch",
        default_value="0.784",
        description="Base-to-Livox pitch passed from locomposition_bringup/launch/bringup.launch.py."
    )
    base_to_livox_roll_arg = DeclareLaunchArgument(
        "base_to_livox_roll",
        default_value="0.0",
        description="Base-to-Livox roll passed from locomposition_bringup/launch/bringup.launch.py."
    )
