...
time tar -cf - ./logs/clean_rl/ | pv -s ${TOTAL_BYTES} | zstd --ultra -22 -T0 -o $HOME/Downloads/locomposition-logs-and-runs.tar.zst
...
swish $HOME/Downloads/locomposition-logs-and-runs.tar.zst
