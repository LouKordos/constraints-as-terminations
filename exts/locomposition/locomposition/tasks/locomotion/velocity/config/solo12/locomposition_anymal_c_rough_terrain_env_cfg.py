...
from .locomposition_go2_rough_terrain_env_cfg import Go2RoughTerrainEnvCfg, force_hard_terrain
...
class AnymalCRoughTerrainEnvCfg(Go2RoughTerrainEnvCfg):
    ...
    def __post_init__(self):
        ...
        # THIS MIGHT NEED ADJUSTMENTS BECAUSE ACTION RATE COULD BE TOO HIGH
        self.constraints.action_rate.params["limit"] = 80.0 * 1.6
